...
namespace osc {
  ...
  extern "C" int main(int ac, char **av)
  {
    try {
      ...
      SampleWindow *window = new SampleWindow(modelName + "-textures",
                                              model,camera,worldScale, windowWidth, windowHeight);
      window->writeAccelBuildTime("optix-" + std::to_string(windowWidth) + "x" + std::to_string(windowHeight) + modelName + "-textures-accelbuildtime.txt");
      window->run();
